...
const string saved_weights = "model-neural-network-bchmk.dat";
const string report_file = "training-report-bchmk.dat";
const string benchmark_file = "benchmark_train.txt";

const int Training_samples = 5000;
const int width = 28;
const int height = 28;
